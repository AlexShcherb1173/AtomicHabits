            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1,
                        help_text="Как часто выполнять привычку (в днях). Допустимо от 1 до 7 (не реже, чем раз в неделю).",
                        validators=[habits.validators.validate_periodicity_1_to_7_days],
                ...
                (
                    ...
                    models.DurationField(
                        ...
                        validators=[
                            habits.validators.validate_duration_max_120_seconds
                        ],
